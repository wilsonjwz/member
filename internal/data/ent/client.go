...
// CreateBulk returns a builder for creating a bulk of UserExtend entities.
...
// UpdateOneID returns an update builder for the given id.
func (c *UserExtendClient) UpdateOneID(id int) *UserExtendUpdateOne {
...
// DeleteOneID returns a delete builder for the given id.
func (c *UserExtendClient) DeleteOneID(id int) *UserExtendDeleteOne {
...
func (c *UserExtendClient) Get(ctx context.Context, id int) (*UserExtend, error) {
	return c.Query().Where(userextend.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *UserExtendClient) GetX(ctx context.Context, id int) *UserExtend {
	obj, err := c.Get(ctx, id)
	if err != nil {
		panic(err)
	}
